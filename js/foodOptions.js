...
const eggStyleModifiers = {
  없음: {tip: "계란은 생략해주세요."},
  반숙: {
    tip: "계란을 넣고 흰자만 익으면 바로 불을 꺼주세요. 노른자가 흐르는 반숙이 완성돼요.",
  },
...
const shabuModifiers = {
  brothType: {
    ...
    "얼큰한 육수": {
      tip: "장국에 고춧가루 1큰술을 추가해 얼큰하게 만들어주세요.",
    },
    "스키야키 육수": {
      tip: "간장 2큰술, 미림 1큰술, 설탕 1큰술을 물에 섞어 달콤짭짤한 육수를 만들어주세요.",
    },
    "마라 육수": {
      tip: "시판 마라 육수 베이스를 사용해주세요. 마트에서 쉽게 구할 수 있어요.",
    },
  },
  sauce: {
    "폰즈 소스": {tip: "시판 폰즈 소스에 찍어 드세요. 상큼하고 담백해요."},
    "스위트 칠리 소스": {
      tip: "시판 스위트 칠리 소스에 찍어 드세요. 달콤하고 약간 매워요.",
    },
    "탕콩 소스": {
      tip: "땅콩버터 1큰술 + 간장 1큰술 + 참기름 0.5큰술을 섞어주세요.",
    },
    참소스: {tip: "참깨드레싱을 활용하거나 참기름 + 소금으로 만들어주세요."},
  },
  endMeal: {
    볶음밥: {
      tip: "남은 육수에 밥 1공기를 넣고 볶아주세요. 계란과 김가루를 추가하면 완벽해요!",
    },
    칼국수: {tip: "남은 육수에 칼국수 면을 넣고 3~4분 끓여주세요."},
    죽: {
      tip: "남은 육수에 밥을 넣고 약불에서 5분 끓이다가 계란을 풀어 넣으면 완성이에요.",
    },
  },
};
...
const dakEndMealModifiers = {
  없음: {tip: ""},
  "볶음밥 추가": {
    tip: "닭볶음탕을 다 먹은 후 남은 양념에 밥 1공기를 넣고 볶아주세요. 고소하고 맛있어요!",
  },
};
...
const soupAmountModifiers = {
  자작하게: {
    tip: "물을 미역이 잠길 정도로만 넣어주세요. 진한 국물이 완성돼요.",
  },
  보통: {tip: "기본 레시피 그대로 물을 넣어주세요."},
  넉넉하게: {
    tip: "물을 넉넉하게 넣어주세요. 마지막에 간을 다시 한번 확인해주세요.",
  },
};
...
const spicyToppingModifiers = {
  ...
  페페론치노: {
    tip: "페페론치노를 2~3개 부숴서 씨까지 함께 볶아주세요. 많이 매워요!",
    extraIngredients: [{name: "페페론치노", amount: 2, unit: "개"}],
  },
  고춧가루: {
    tip: "고춧가루 0.5큰술을 마늘 볶을 때 함께 넣어주세요.",
    extraIngredients: [{name: "고춧가루", amount: 0.5, unit: "큰술"}],
  },
  "둘 다": {
    tip: "페페론치노와 고춧가루를 함께 넣어주세요. 매우 매울 수 있어요!",
    extraIngredients: [
      {name: "페페론치노", amount: 2, unit: "개"},
